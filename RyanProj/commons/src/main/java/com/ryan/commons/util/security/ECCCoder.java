...
public abstract class ECCCoder extends Coder {
    ...
    public static final String ECCProvider = "SunEC";
    ...
    public static byte[] decrypt(byte[] data, String key) throws Exception {
        ...
        KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM, ECCProvider);
    ...
    public static Map<String, Object> initKey() throws Exception {
        ...
        ECParameterSpec ecParameterSpec = new ECParameterSpec(ellipticCurve, g,
                n, h);
        // 公钥
//        ECPublicKey publicKey = ECUtil.decodeX509ECPublicKey(ECUtil.x509EncodeECPublicKey(g, ecParameterSpec));
//        // 私钥
//        ECPrivateKey privateKey = ECUtil.generateECPrivateKey(s, ecParameterSpec);
